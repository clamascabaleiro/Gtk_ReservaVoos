...
class Fiestra(Gtk.Window):
    ...
    def on_rbts_toggle (self, control, nome):
        ...
        if control.get_active():
            fin = self.bufferTxv.get_end_iter()
            self.bufferTxv.insert(fin,"Activado o RadioButton " + nome + "\n")
